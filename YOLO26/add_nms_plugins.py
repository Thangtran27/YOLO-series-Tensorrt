...
import argparse
def create_attrs(topK, keepTopK, num_classes):
    attrs = {}
...
def create_and_add_plugin_node(graph, topK, keepTopK, num_classes):
    ...
    mns_node = gs.Node(
        ...
        attrs=create_attrs(topK, keepTopK, num_classes),
...
def main():
    ...
    parser.add_argument("-n", "--num_classes", help="number of classes", default=1)
    ...
    graph = create_and_add_plugin_node(graph, int(args.topK), int(args.keepTopK), int(args.num_classes))
