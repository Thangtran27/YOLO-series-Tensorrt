...
class YOLO12(object):
    def __init__(self, 
            model_weights = 'weights/yolo12-nms-fp16.trt', 
            max_size = 640, 
            names = 'coco.names'):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='weights/best.trt', help='weights path')
    parser.add_argument('--max_size', type=int, default=640, help='max size of input image')
    parser.add_argument('--input', type=str, default='bus.jpg', help='input image path')
    opt = parser.parse_args()
    model = YOLO12(opt.model, opt.max_size)
